...
These binaries are built for **CPython 3.10**. A sibling tree `../vendor_py312/`
holds the **3.12** build (pybind11). `hardware/sdk_paths.py` auto-selects the
tree from `sys.version_info` at runtime.
